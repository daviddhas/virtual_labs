...
<html>
    <head>
        <title>Virtual FPGA Laboratory</title>
       ...
       <div class="navbar navbar-default navbar-fixed-top"><div class="container">
        ...
        <div class="container" style="margin-top: 85px;">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form method="post" enctype="multipart/form-data" class="form-horizontal">
                            <fieldset>
                                <legend>Synthesis through ODIN</legend>
                                <div class="form-group">
                                    <p> <a href="./simulation.php">Click here </a> to continue to the simulation. </p>;
			...
			chdir('../vtr_release/ODIN_II/');
                        passthru('./odin_II.exe -V /var/www/html/vlabs/sessions/'.$_SESSION['vlabuser'].'/uploader_dut.v -o /var/www/html/vlabs/sessions/'.$_SESSION['vlabuser'].'/output.blif');
			#passthru('perl david_checker.pl');
                        echo '</pre></p>';
			chdir($currentdir);
			if(file_exists('/var/www/html/vlabs/sessions/'.$_SESSION['vlabuser'].'/output.blif')) {
				echo '<p><a href="sessions/'.$_SESSION['vlabuser'].'/output.blif">Click here</a> to download output blif file.</p>';
		                echo '<p> <a href="./simulation.php"> Click here </a> to continue to the simulation. </p>';
                         	}
                    }else {
                        echo '<h4>Error:</h4>';
